    ...
    <div className="auto-exact-results">
      <section className="panel">
        ...
        {promoteList.length === 0 ? (
          ...
          <div
            className="table-wrap table-wrap--compact table-wrap--promote table-wrap--promote-scroll"
            role="region"
      ...
      <section className="panel">
        ...
        {reviewQueue.length === 0 ? (
          ...
          <div className="table-wrap table-wrap--compact table-wrap--review table-wrap--review-scroll" role="region" aria-labelledby="review-queue-heading" tabIndex={-1}>
